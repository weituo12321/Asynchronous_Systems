...
var == <<osn, hsn, orc,rd,working,updatingrc,sendingrc,requests, waiting, replies, cs, defer, message, rcs>>
----------------------------------------------------------
...
Invariant ==   \A i \in SITES: \A j \in SITES : i \in cs /\ i # j => j \notin cs (*same function as mutual exclusion*)
Liveness == \A s \in SITES: SF_var(Choose_a_sequence_number(s))
